...
import { notificationsData } from "@/constants copy/dummyData";
      ...
      <View style={[styles.container, { marginTop: headerHeight }]}>
        <FlatList
          ...
          renderItem={({ item, index }) => (
            <Animated.View entering={FadeInDown.delay(300 +index+100).duration(500)} style={styles.notificationWrapper}>
